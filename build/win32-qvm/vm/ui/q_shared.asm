...
;1123:===================
;1124:*/
;1125:const char *Info_NextPair( const char *s, char *key, char *value ) {
line 1128
;1126:	char *o;
;1127:
;1128:	if ( *s == '\\' ) {
...
;1159:===================
;1160:*/
;1161:static int Info_RemoveKey( char *s, const char *key ) {
line 1166
;1162:	char	*start;
;1163:	char 	*pkey;
;1164:	int		key_len, len;
;1165:
;1166:	key_len = (int) strlen( key );
ADDRFP4 4
INDIRP4
ARGP4
ADDRLP4 16
...
line 1187
;1186:
;1187:		if ( len == key_len && Q_strkey( pkey, key, key_len ) )
ADDRLP4 12
INDIRI4
ADDRLP4 4
INDIRI4
...
;1188:		{
line 1189
;1189:			memmove( start, s, strlen( s ) + 1 ); // remove this part
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 32
...
;1201:/*
;1202:==================
;1203:Info_ValidateKeyValue
;1204:
;1205:Some characters are illegal in info strings because they
;1206:can mess up the server's parsing
;1207:==================
;1208:*/
;1209:qboolean Info_Validate( const char *s )
;1210:{
line 1211
;1211:	for ( ;; )
LABELV $485
...
;1228:/*
;1229:==================
;1230:Info_ValidateKeyValue
;1231:==================
;1232:*/
;1233:qboolean Info_ValidateKeyValue( const char *s )
;1234:{
line 1235
;1235:	for ( ;; )
LABELV $497
...
;1253:/*
;1254:==================
;1255:Info_SetValueForKey
;1256:
;1257:Changes or adds a key/value pair
;1258:==================
;1259:*/
;1260:qboolean Info_SetValueForKey( char *s, const char *key, const char *value ) {
line 1264
;1261:	char	newi[MAX_INFO_STRING+2];
;1262:	int		len1, len2;
;1263:
;1264:	len1 = (int)strlen( s );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 1036
...
ASGNI4
line 1265
;1265:	if ( len1 >= MAX_INFO_STRING ) {
ADDRLP4 0
INDIRI4
CNSTI4 1024
LTI4 $510
line 1266
;1266:		Com_Error( ERR_DROP, "Info_SetValueForKey: oversize infostring" );
CNSTI4 1
ARGI4
ADDRGP4 $512
ARGP4
...
line 1269
;1268:
;1269:	if ( !Info_ValidateKeyValue( key ) || *key == '\0' ) {
ADDRFP4 4
INDIRP4
ARGP4
ADDRLP4 1040
...
LABELV $515
line 1270
;1270:		Com_Printf( S_COLOR_YELLOW "Invalid key name: '%s'\n", key );
ADDRGP4 $516
ARGP4
ADDRFP4 4
INDIRP4
...
;1272:	}
;1273:
;1274:	if ( !Info_ValidateKeyValue( value ) ) {
ADDRFP4 8
INDIRP4
ARGP4
ADDRLP4 1044
...
NEI4 $517
line 1275
;1275:		Com_Printf( S_COLOR_YELLOW "Invalid value name: '%s'\n", value );
ADDRGP4 $519
ARGP4
ADDRFP4 8
INDIRP4
...
;1277:	}
;1278:
;1279:	len1 -= Info_RemoveKey( s, key );
ADDRFP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
line 1283
;1282:
;1283:	len2 = Com_sprintf( newi, sizeof( newi ), "\\%s\\%s", key, value );
ADDRLP4 4
ARGP4
CNSTI4 1026
ARGI4
...
line 1285
;1284:	
;1285:	if ( len1 + len2 >= MAX_INFO_STRING )
ADDRLP4 0
INDIRI4
ADDRLP4 1032
INDIRI4
...
;1286:	{
line 1287
;1287:		Com_Printf( S_COLOR_YELLOW "Info string length exceeded\n" );
ADDRGP4 $526
ARGP4
ADDRGP4 Com_Printf
CALLV
...
;1296:/*
;1297:==================
;1298:Info_SetValueForKey_Big
;1299:
;1300:Changes or adds a key/value pair
;1301:==================
;1302:*/
;1303:qboolean Info_SetValueForKey_Big( char *s, const char *key, const char *value ) {
line 1307
;1304:	char	newi[BIG_INFO_STRING+2];
;1305:	int		len1, len2;
;1306:
;1307:	len1 = (int)strlen( s );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 8204
...
ASGNI4
line 1308
;1308:	if ( len1 >= BIG_INFO_STRING ) {
ADDRLP4 0
INDIRI4
CNSTI4 8192
LTI4 $528
line 1309
;1309:		Com_Error( ERR_DROP, "Info_SetValueForKey: oversize infostring" );
CNSTI4 1
ARGI4
ADDRGP4 $512
ARGP4
...
line 1312
;1311:
;1312:	if ( !Info_ValidateKeyValue( key ) || *key == '\0' ) {
ADDRFP4 4
INDIRP4
ARGP4
ADDRLP4 8208
...
LABELV $532
line 1313
;1313:		Com_Printf( S_COLOR_YELLOW "Invalid key name: '%s'\n", key );
ADDRGP4 $516
ARGP4
ADDRFP4 4
INDIRP4
...
;1315:	}
;1316:
;1317:	if ( !Info_ValidateKeyValue( value ) ) {
ADDRFP4 8
INDIRP4
ARGP4
ADDRLP4 8212
...
NEI4 $533
line 1318
;1318:		Com_Printf( S_COLOR_YELLOW "Invalid value name: '%s'\n", value );
ADDRGP4 $519
ARGP4
ADDRFP4 8
INDIRP4
...
;1320:	}
;1321:
;1322:	len1 -= Info_RemoveKey( s, key );
ADDRFP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
line 1326
;1325:
;1326:	len2 = Com_sprintf( newi, sizeof( newi ), "\\%s\\%s", key, value );
ADDRLP4 4
ARGP4
CNSTI4 8194
ARGI4
...
line 1328
;1327:
;1328:	if ( len1 + len2 >= BIG_INFO_STRING )
ADDRLP4 0
INDIRI4
ADDRLP4 8200
INDIRI4
...
;1329:	{
line 1330
;1330:		Com_Printf( S_COLOR_YELLOW "BIG Info string length exceeded\n" );
ADDRGP4 $540
ARGP4
ADDRGP4 Com_Printf
CALLV
