...
;81:} cvarTable_t;
;82:
;83:#define DECLARE_UI_CVAR
;84:	#include "ui_cvar.h"
;85:#undef DECLARE_UI_CVAR
;86:
;87:// bk001129 - made static to avoid aliasing.
;88:static cvarTable_t		cvarTable[] = {
;89:
;90:#define UI_CVAR_LIST
;91:	#include "ui_cvar.h"
;92:#undef UI_CVAR_LIST
;93:
;94:};
;95:
;96:// bk001129 - made static to avoid aliasing
;97:static int cvarTableSize = sizeof(cvarTable) / sizeof(cvarTable[0]);
;98:
;99:
;100:/*
;101:=================
;102:UI_RegisterCvars
;103:=================
;104:*/
;105:void UI_RegisterCvars( void ) {
line 109
;106:	int			i;
;107:	cvarTable_t	*cv;
;108:
;109:	for ( i = 0, cv = cvarTable ; i < cvarTableSize ; i++, cv++ ) {
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRLP4 0
...
LABELV $142
line 110
;110:		trap_Cvar_Register( cv->vmCvar, cv->cvarName, cv->defaultString, cv->cvarFlags );
ADDRLP4 0
INDIRP4
INDIRP4
ARGP4
...
;117:=================
;118:*/
;119:void UI_UpdateCvars( void ) {
line 123
;120:	int			i;
;121:	cvarTable_t	*cv;
;122:
;123:	for ( i = 0, cv = cvarTable ; i < cvarTableSize ; i++, cv++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRLP4 4
...
LABELV $147
line 124
;124:		trap_Cvar_Update( cv->vmCvar );
ADDRLP4 4
INDIRP4
INDIRP4
ARGP4
...
;132:=================
;133:*/
;134:void UI_VideoCheck( int time ) 
;135:{
line 136
;136:	if ( abs( time - uis.lastVideoCheck ) > 1000 ) {
ADDRFP4 0
INDIRI4
ADDRGP4 uis+11472
INDIRI4
...
line 139
;137:		
;138:		int oldWidth, oldHeight;
;139:		oldWidth = uis.glconfig.vidWidth;
ADDRLP4 4
ADDRGP4 uis+56+11304
INDIRI4
ASGNI4
line 140
;140:		oldHeight = uis.glconfig.vidHeight;
ADDRLP4 8
...
line 142
;141:
;142:		trap_GetGlconfig( &uis.glconfig );
ADDRGP4 uis+56
ARGP4
...
line 144
;143:
;144:		if ( uis.glconfig.vidWidth != oldWidth || uis.glconfig.vidHeight != oldHeight ) {
ADDRGP4 uis+56+11304
INDIRI4
ADDRLP4 4
INDIRI4
...
ASGNF4
line 148
;147:			// for 640x480 virtualized screen
;148:			if ( uis.glconfig.vidWidth * 480 > uis.glconfig.vidHeight * 640 ) {
ADDRGP4 uis+56+11304
INDIRI4
CNSTI4 480
MULI4
...
LEI4 $169
line 150
;149:				// wide screen, scale by height
;150:				uis.scale = uis.glconfig.vidHeight * (1.0/480.0);
ADDRGP4 uis+11432
ADDRGP4 uis+56+11308
INDIRI4
CVIF4 4
...
ASGNF4
line 151
;151:				uis.biasX = 0.5 * ( uis.glconfig.vidWidth - ( uis.glconfig.vidHeight * (640.0/480.0) ) );
ADDRGP4 uis+11436
ADDRGP4 uis+56+11304
INDIRI4
CVIF4 4
...
LABELV $169
line 154
;153:				// no wide screen, scale by width
;154:				uis.scale = uis.glconfig.vidWidth * (1.0/640.0);
ADDRGP4 uis+11432
ADDRGP4 uis+56+11304
INDIRI4
CVIF4 4
...
ASGNF4
line 155
;155:				uis.biasY = 0.5 * ( uis.glconfig.vidHeight - ( uis.glconfig.vidWidth * (480.0/640) ) );
ADDRGP4 uis+11440
ADDRGP4 uis+56+11308
INDIRI4
CVIF4 4
...
line 158
;157:
;158:			uis.screenXmin = 0.0 - (uis.biasX / uis.scale);
ADDRGP4 uis+11448
CNSTF4 0
ADDRGP4 uis+11436
INDIRF4
...
ASGNF4
line 159
;159:			uis.screenXmax = 640.0 + (uis.biasX / uis.scale);
ADDRGP4 uis+11452
ADDRGP4 uis+11436
INDIRF4
ADDRGP4 uis+11432
...
line 161
;160:
;161:			uis.screenYmin = 0.0 - (uis.biasY / uis.scale);
ADDRGP4 uis+11456
CNSTF4 0
ADDRGP4 uis+11440
INDIRF4
...
ASGNF4
line 162
;162:			uis.screenYmax = 480.0 + (uis.biasY / uis.scale);
ADDRGP4 uis+11460
ADDRGP4 uis+11440
INDIRF4
ADDRGP4 uis+11432
...
line 164
;163:
;164:			uis.cursorScaleR = 1.0 / uis.scale;
ADDRGP4 uis+11444
CNSTF4 1065353216
ADDRGP4 uis+11432
INDIRF4
...
ASGNF4
line 165
;165:			if ( uis.cursorScaleR < 0.5 ) {
ADDRGP4 uis+11444
INDIRF4
CNSTF4 1056964608
GEF4 $205
line 166
;166:				uis.cursorScaleR = 0.5;
ADDRGP4 uis+11444
CNSTF4 1056964608
ASGNF4
line 167
