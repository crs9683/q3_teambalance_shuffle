...
;206:	do {
line 207
;207:		s = Info_NextPair( s, key, value );
ADDRLP4 3080
INDIRP4
ARGP4
ADDRLP4 2056
...
;230:	do {
line 231
;231:		s = Info_NextPair( s, key, value );
ADDRLP4 3080
INDIRP4
ARGP4
ADDRLP4 2056
...
ASGNI4
line 250
;250:		if ( s_serverinfo.list.numitems >= MAX_INFO_LINES )
ADDRGP4 s_serverinfo+716+72
INDIRI4
CNSTI4 64
LTI4 $241
...
pop
line 259
;259:	Menu_AddItem( &s_serverinfo.menu, (void*) &s_serverinfo.list );
ADDRGP4 s_serverinfo
ARGP4
ADDRGP4 s_serverinfo+716
ARGP4
...
line 261
;260:
;261:	UI_PushMenu( &s_serverinfo.menu );
ADDRGP4 s_serverinfo
ARGP4
ADDRGP4 UI_PushMenu
CALLV
